...
<div class="container" style="background-image:{{asset('/img/banjo.jpg')}}">
<div class="register-box" >
  <div class="register-logo">
    <a href="#"style="margin-right:-100px">SMS REGISTER</a>
  </div>

  <div class="card"style="width:500px " margin-right:60px;>
    <div class="card-body register-card-body">
      ...
      <form method="POST" action="{{ route('register') }}">
        ...
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="Full name" @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
